...
// node_modules/randomized-hopcroft-karp/dist/main.js
var require_main = __commonJS({
  "node_modules/randomized-hopcroft-karp/dist/main.js"(exports) {
    init_shims();
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var inf = 2147483647;
    var nil = -1;
    function findMatching(m, n, edges, groups) {
      const adj = new Array(m).fill(void 0).map(() => []);
      edges.forEach(([u, v]) => {
        adj[u].push(v);
      });
      ...
      const bfs = () => {
        ...
        dists[nil + 1] = inf;
        for (let u; (u = queue.shift()) !== void 0; ) {
      ...
      if (groups === void 0) {
        ...
        while (bfs()) {
          ...
          let scheduledUs = [];
          let lastCount = -1;
          const unvisitedUsByGroup = Object.fromEntries([...new Set(groups)].map((g) => [g, new Set()]));
          for (const u of remainingUs) {
            unvisitedUsByGroup[groups[u]].add(u);
          }
          const pop = () => {
            let u;
            while ((u = scheduledUs.shift()) === void 0 || scheduledGs.size === 0) {
              lastCount += 1;
              const gs = gsByCount[lastCount];
              if (gs === void 0) {
                return void 0;
              }
              scheduledUs = shuffle([...gs].flatMap((g) => [...unvisitedUsByGroup[g]]));
              scheduledGs = gs;
            }
      ...
      return Array.from(uPair).map((v, u) => [u, v]).filter(([u, v]) => v !== nil);
    }
    exports.default = findMatching;
    var shuffle = (iter) => {
      const array = [...iter];
...
// node_modules/randomized-hopcroft-karp/dist/index.js
var require_dist = __commonJS({
  "node_modules/randomized-hopcroft-karp/dist/index.js"(exports) {
    init_shims();
    "use strict";
...
// .svelte-kit/output/server/app.js
var import_randomized_hopcroft_karp = __toModule(require_dist());
var import_free_solid_svg_icons = __toModule(require_free_solid_svg_icons());
var import_svelte_local_storage_store = __toModule(require_dist2());
function noop2() {
}
function run(fn) {
  return fn();
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-f78eae16.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-f78eae16.js", assets + "/_app/chunks/vendor-c3f4fdf7.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "robots.txt", "size": 70, "type": "text/plain" }],
  ...
  routes: [
    ...
    {
      type: "page",
      pattern: /^\/check-chore-completion\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/check-chore-completion.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/change-current-chores\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/change-current-chores.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/change-chores\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/change-chores.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/check-absence\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/check-absence.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/choose-chores\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/choose-chores.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/change-names\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/change-names.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/add-history\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/add-history.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/check-chore-completion.svelte": () => Promise.resolve().then(function() {
    return checkChoreCompletion;
  }),
  "src/routes/change-current-chores.svelte": () => Promise.resolve().then(function() {
    return changeCurrentChores;
  }),
  "src/routes/change-chores.svelte": () => Promise.resolve().then(function() {
    return changeChores;
  }),
  "src/routes/check-absence.svelte": () => Promise.resolve().then(function() {
    return checkAbsence;
  }),
  "src/routes/choose-chores.svelte": () => Promise.resolve().then(function() {
    return chooseChores;
  }),
  "src/routes/change-names.svelte": () => Promise.resolve().then(function() {
    return changeNames;
  }),
  "src/routes/add-history.svelte": () => Promise.resolve().then(function() {
    return addHistory;
  }),
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-cf9f3c80.js", "css": ["assets/pages/__layout.svelte-d5565b09.css"], "js": ["pages/__layout.svelte-cf9f3c80.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js", "chunks/matching-2fd2fbcb.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-c947447b.js", "css": [], "js": ["error.svelte-c947447b.js", "chunks/vendor-c3f4fdf7.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-656e4adc.js", "css": [], "js": ["pages/index.svelte-656e4adc.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js"], "styles": [] }, "src/routes/check-chore-completion.svelte": { "entry": "pages/check-chore-completion.svelte-086506cb.js", "css": [], "js": ["pages/check-chore-completion.svelte-086506cb.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js", "chunks/YesNo-b1f6fbac.js", "chunks/matching-2fd2fbcb.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/change-current-chores.svelte": { "entry": "pages/change-current-chores.svelte-08c104a5.js", "css": [], "js": ["pages/change-current-chores.svelte-08c104a5.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js"], "styles": [] }, "src/routes/change-chores.svelte": { "entry": "pages/change-chores.svelte-594935b6.js", "css": [], "js": ["pages/change-chores.svelte-594935b6.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js", "chunks/ManWoman-fb74bbfe.js"], "styles": [] }, "src/routes/check-absence.svelte": { "entry": "pages/check-absence.svelte-1491b819.js", "css": [], "js": ["pages/check-absence.svelte-1491b819.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js", "chunks/YesNo-b1f6fbac.js", "chunks/matching-2fd2fbcb.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/choose-chores.svelte": { "entry": "pages/choose-chores.svelte-ee7b8650.js", "css": [], "js": ["pages/choose-chores.svelte-ee7b8650.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js"], "styles": [] }, "src/routes/change-names.svelte": { "entry": "pages/change-names.svelte-aa41ed56.js", "css": [], "js": ["pages/change-names.svelte-aa41ed56.js", "chunks/vendor-c3f4fdf7.js", "chunks/ManWoman-fb74bbfe.js", "chunks/stores-98bc500e.js"], "styles": [] }, "src/routes/add-history.svelte": { "entry": "pages/add-history.svelte-4d9118fc.js", "css": [], "js": ["pages/add-history.svelte-4d9118fc.js", "chunks/vendor-c3f4fdf7.js", "chunks/stores-98bc500e.js", "chunks/YesNo-b1f6fbac.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/admin.svelte": { "entry": "pages/admin.svelte-eaae2a59.js", "css": [], "js": ["pages/admin.svelte-eaae2a59.js", "chunks/vendor-c3f4fdf7.js", "pages/index.svelte-656e4adc.js", "chunks/stores-98bc500e.js"], "styles": [] } };
...
var names = (0, import_svelte_local_storage_store.writable)("names", [
...
var chores = (0, import_svelte_local_storage_store.writable)("chores", [
...
var currentMatching = (0, import_svelte_local_storage_store.writable)("currentMatching", [
...
var absence = (0, import_svelte_local_storage_store.writable)("absence", [
...
var archiveWeeks = (0, import_svelte_local_storage_store.writable)("archiveWeeks", [[{ "personId": 0, "choreId": 0, "completed": true }, { "personId": 1, "choreId": 4, "completed": true }, { "personId": 2, "choreId": 1, "completed": false }, { "personId": 3, "choreId": 6, "completed": true }, { "personId": 4, "choreId": 2, "completed": true }, { "personId": 5, "choreId": 5, "completed": true }, { "personId": 6, "choreId": 3, "completed": true }, { "personId": 7, "choreId": 0, "completed": true }, { "personId": 8, "choreId": 4, "completed": true }, { "personId": 9, "choreId": 6, "completed": true }], [{ "personId": 0, "choreId": 0, "completed": true }, { "personId": 1, "choreId": 1, "completed": true }, { "personId": 2, "choreId": 7, "completed": true }, { "personId": 3, "choreId": 2, "completed": false }, { "personId": 4, "choreId": 1, "completed": true }, { "personId": 5, "choreId": 4, "completed": true }, { "personId": 6, "choreId": 5, "completed": true }, { "personId": 7, "choreId": 0, "completed": true }, { "personId": 8, "choreId": 3, "completed": true }, { "personId": 9, "choreId": 6, "completed": true }], [{ "personId": 0, "choreId": 5, "completed": true }, { "personId": 1, "choreId": 6, "completed": true }, { "personId": 2, "choreId": 7, "completed": true }, { "personId": 3, "choreId": 2, "completed": true }, { "personId": 4, "choreId": 4, "completed": true }, { "personId": 5, "choreId": 0, "completed": true }, { "personId": 6, "choreId": 1, "completed": true }, { "personId": 7, "choreId": 0, "completed": true }, { "personId": 8, "choreId": 4, "completed": true }, { "personId": 9, "choreId": 1, "completed": true }], [{ "personId": 0, "choreId": 1, "completed": false }, { "personId": 1, "choreId": 0, "completed": false }, { "personId": 2, "choreId": 7, "completed": true }, { "personId": 3, "choreId": 4, "completed": true }, { "personId": 4, "choreId": 5, "completed": true }, { "personId": 5, "choreId": 1, "completed": false }, { "personId": 6, "choreId": 4, "completed": true }, { "personId": 7, "choreId": 3, "completed": true }, { "personId": 8, "choreId": 6, "completed": true }, { "personId": 9, "choreId": 0, "completed": true }], [{ "personId": 0, "choreId": 1, "completed": true }, { "personId": 1, "choreId": 0, "completed": true }, { "personId": 2, "choreId": 5, "completed": true }, { "personId": 3, "choreId": 4, "completed": true }, { "personId": 4, "choreId": 3, "completed": true }, { "personId": 5, "choreId": 1, "completed": true }, { "personId": 6, "choreId": 0, "completed": true }, { "personId": 7, "choreId": 6, "completed": true }, { "personId": 8, "choreId": 2, "completed": true }, { "personId": 9, "choreId": 4, "completed": true }], [{ "personId": 0, "choreId": 2, "completed": true }, { "personId": 1, "choreId": 1, "completed": true }, { "personId": 2, "choreId": 1, "completed": true }, { "personId": 3, "choreId": 6, "completed": true }, { "personId": 4, "choreId": 0, "completed": true }, { "personId": 5, "choreId": 5, "completed": true }, { "personId": 6, "choreId": 4, "completed": true }, { "personId": 7, "choreId": 4, "completed": true }, { "personId": 8, "choreId": 0, "completed": true }, { "personId": 9, "choreId": 3, "completed": true }], [{ "personId": 0, "choreId": 4, "completed": true }, { "personId": 1, "choreId": 4, "completed": true }, { "personId": 2, "choreId": 2, "completed": true }, { "personId": 3, "choreId": 0, "completed": true }, { "personId": 4, "choreId": 1, "completed": true }, { "personId": 5, "choreId": 3, "completed": true }, { "personId": 6, "choreId": 5, "completed": true }, { "personId": 7, "choreId": 0, "completed": true }, { "personId": 8, "choreId": 1, "completed": true }, { "personId": 9, "choreId": 6, "completed": true }]]);
var nrPresent = writable2(10);
var css$1 = {
  code: "header.svelte-1bzzx5e.svelte-1bzzx5e{display:flex;justify-content:space-between;flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:1024px;margin:0 auto;box-sizing:border-box}nav.svelte-1bzzx5e.svelte-1bzzx5e{display:flex;justify-content:center;--background:rgba(255, 255, 255, 0.7)}ul.svelte-1bzzx5e.svelte-1bzzx5e{position:relative;padding:0;margin:0;height:3em;display:flex;justify-content:center;align-items:center;list-style:none;background:var(--background);background-size:contain}li.svelte-1bzzx5e.svelte-1bzzx5e{position:relative;height:100%}button.active.svelte-1bzzx5e.svelte-1bzzx5e{background-color:darkcyan}nav.svelte-1bzzx5e a.svelte-1bzzx5e{display:flex;height:100%;align-items:center;padding:2em 1em;color:var(--heading-color);font-weight:700;font-size:0.8rem;text-transform:uppercase;letter-spacing:10%;text-decoration:none;transition:color 0.2s linear}a.svelte-1bzzx5e.svelte-1bzzx5e:hover{color:var(--accent-color)}",
  map: `{"version":3,"file":"Header.svelte","sources":["Header.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { page } from '$app/stores';\\r\\nimport { absence, names, nrPresent, currentMatching, archiveWeeks, \\r\\n// activeChores,\\r\\nchores } from '../stores';\\r\\nimport { matchAndUpdate } from '../matching';\\r\\nimport { goto } from '$app/navigation';\\r\\nfunction randomizeChoresClick() {\\r\\n    console.log(\\"Tried matching\\");\\r\\n    let match = matchAndUpdate(false, currentMatching, archiveWeeks, chores, names, absence);\\r\\n    currentMatching.set(match);\\r\\n    goto('/');\\r\\n}\\r\\n$: isAdmin = $page.path === '/admin';\\r\\n<\/script>\\r\\n\\r\\n<header>\\r\\n\\t<nav>\\r\\n\\t\\t<ul>\\r\\n\\t\\t\\t<li>\\r\\n\\t\\t\\t\\t<a sveltekit:prefetch href=\\"/\\"\\r\\n\\t\\t\\t\\t\\t><button class:active={$page.path === '/'} class=\\"button button-primary\\"\\r\\n\\t\\t\\t\\t\\t\\t>Huidige huistaken</button\\r\\n\\t\\t\\t\\t\\t></a\\r\\n\\t\\t\\t\\t>\\r\\n\\t\\t\\t</li>\\r\\n\\t\\t\\t{#if isAdmin}\\r\\n\\t\\t\\t<li>\\r\\n\\t\\t\\t\\t<a sveltekit:prefetch href=\\"/change-names\\"\\r\\n\\t\\t\\t\\t\\t><button class:active={$page.path === '/change-names'} class=\\"button button-primary\\"\\r\\n\\t\\t\\t\\t\\t\\t>Namen veranderen</button\\r\\n\\t\\t\\t\\t\\t></a\\r\\n\\t\\t\\t\\t>\\r\\n\\t\\t\\t</li>\\r\\n\\t\\t\\t<li>\\r\\n\\t\\t\\t\\t<a sveltekit:prefetch href=\\"/change-chores\\"\\r\\n\\t\\t\\t\\t\\t><button class:active={$page.path === '/change-chores'} class=\\"button button-primary\\"\\r\\n\\t\\t\\t\\t\\t\\t>Taken veranderen</button\\r\\n\\t\\t\\t\\t\\t></a\\r\\n\\t\\t\\t\\t>\\r\\n\\t\\t\\t</li>\\r\\n\\t\\t\\t{/if}\\r\\n\\r\\n\\t\\t\\t<li>\\r\\n\\t\\t\\t\\t<a sveltekit:prefetch href=\\"/check-chore-completion\\"\\r\\n\\t\\t\\t\\t\\t><button\\r\\n\\t\\t\\t\\t\\t\\tclass:active={$page.path === '/check-chore-completion'}\\r\\n\\t\\t\\t\\t\\t\\tclass=\\"button button-primary\\">Nieuwe huistaken</button\\r\\n\\t\\t\\t\\t\\t></a\\r\\n\\t\\t\\t\\t>\\r\\n\\t\\t\\t</li>\\r\\n\\t\\t\\t{#if isAdmin}\\r\\n\\t\\t\\t<li>\\r\\n\\t\\t\\t\\t<a sveltekit:prefetch href=\\"/\\">\\r\\n\\t\\t\\t\\t\\t<button class=\\"button button-primary\\" on:click={randomizeChoresClick}\\r\\n\\t\\t\\t\\t\\t\\t>Randomize huistaken</button\\r\\n\\t\\t\\t\\t\\t></a\\r\\n\\t\\t\\t\\t>\\r\\n\\t\\t\\t</li>\\r\\n\\t\\t\\t<li>\\r\\n\\t\\t\\t\\t<a sveltekit:prefetch href=\\"/add-history\\"\\r\\n\\t\\t\\t\\t\\t><button class:active={$page.path === '/add-history'} class=\\"button button-primary\\"\\r\\n\\t\\t\\t\\t\\t\\t>Geschiedenis toevoegen</button\\r\\n\\t\\t\\t\\t\\t></a\\r\\n\\t\\t\\t\\t>\\r\\n\\t\\t\\t</li>\\r\\n\\t\\t\\t<li>\\r\\n\\t\\t\\t\\t<a sveltekit:prefetch href=\\"/change-current-chores\\"\\r\\n\\t\\t\\t\\t\\t><button\\r\\n\\t\\t\\t\\t\\t\\tclass:active={$page.path === '/change-current-chores'}\\r\\n\\t\\t\\t\\t\\t\\tclass=\\"button button-primary\\">Huidige huistaken veranderen</button\\r\\n\\t\\t\\t\\t\\t></a\\r\\n\\t\\t\\t\\t>\\r\\n\\t\\t\\t</li>\\r\\n\\t\\t\\t{/if}\\r\\n\\t\\t</ul>\\r\\n\\t</nav>\\r\\n</header>\\r\\n\\r\\n<style>\\r\\n\\theader {\\r\\n\\t\\tdisplay: flex;\\r\\n\\t\\tjustify-content: space-between;\\r\\n\\t\\tflex: 1;\\r\\n\\t\\tdisplay: flex;\\r\\n\\t\\tflex-direction: column;\\r\\n\\t\\tpadding: 1rem;\\r\\n\\t\\twidth: 100%;\\r\\n\\t\\tmax-width: 1024px;\\r\\n\\t\\tmargin: 0 auto;\\r\\n\\t\\tbox-sizing: border-box;\\r\\n\\t}\\r\\n\\r\\n\\r\\n\\tnav {\\r\\n\\t\\tdisplay: flex;\\r\\n\\t\\tjustify-content: center;\\r\\n\\t\\t--background: rgba(255, 255, 255, 0.7);\\r\\n\\t}\\r\\n\\r\\n\\tul {\\r\\n\\t\\tposition: relative;\\r\\n\\t\\tpadding: 0;\\r\\n\\t\\tmargin: 0;\\r\\n\\t\\theight: 3em;\\r\\n\\t\\tdisplay: flex;\\r\\n\\t\\tjustify-content: center;\\r\\n\\t\\talign-items: center;\\r\\n\\t\\tlist-style: none;\\r\\n\\t\\tbackground: var(--background);\\r\\n\\t\\tbackground-size: contain;\\r\\n\\t}\\r\\n\\r\\n\\tli {\\r\\n\\t\\tposition: relative;\\r\\n\\t\\theight: 100%;\\r\\n\\t}\\r\\n\\r\\n\\tbutton.active {\\r\\n\\t\\tbackground-color: darkcyan;\\r\\n\\t}\\r\\n\\r\\n\\tnav a {\\r\\n\\t\\tdisplay: flex;\\r\\n\\t\\theight: 100%;\\r\\n\\t\\talign-items: center;\\r\\n\\t\\tpadding: 2em 1em;\\r\\n\\t\\tcolor: var(--heading-color);\\r\\n\\t\\tfont-weight: 700;\\r\\n\\t\\tfont-size: 0.8rem;\\r\\n\\t\\ttext-transform: uppercase;\\r\\n\\t\\tletter-spacing: 10%;\\r\\n\\t\\ttext-decoration: none;\\r\\n\\t\\ttransition: color 0.2s linear;\\r\\n\\t}\\r\\n\\r\\n\\ta:hover {\\r\\n\\t\\tcolor: var(--accent-color);\\r\\n\\t}\\r\\n</style>\\r\\n"],"names":[],"mappings":"AA+EC,MAAM,8BAAC,CAAC,AACP,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACvB,CAAC,AAGD,GAAG,8BAAC,CAAC,AACJ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,YAAY,CAAE,wBAAwB,AACvC,CAAC,AAED,EAAE,8BAAC,CAAC,AACH,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,CACT,MAAM,CAAE,GAAG,CACX,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,IAAI,YAAY,CAAC,CAC7B,eAAe,CAAE,OAAO,AACzB,CAAC,AAED,EAAE,8BAAC,CAAC,AACH,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,AACb,CAAC,AAED,MAAM,OAAO,8BAAC,CAAC,AACd,gBAAgB,CAAE,QAAQ,AAC3B,CAAC,AAED,kBAAG,CAAC,CAAC,eAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,GAAG,CAAC,GAAG,CAChB,KAAK,CAAE,IAAI,eAAe,CAAC,CAC3B,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,MAAM,CACjB,cAAc,CAAE,SAAS,CACzB,cAAc,CAAE,GAAG,CACnB,eAAe,CAAE,IAAI,CACrB,UAAU,CAAE,KAAK,CAAC,IAAI,CAAC,MAAM,AAC9B,CAAC,AAED,+BAAC,MAAM,AAAC,CAAC,AACR,KAAK,CAAE,IAAI,cAAc,CAAC,AAC3B,CAAC"}`
};
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  isAdmin = $page.path === "/admin";
  $$unsubscribe_page();
  return `<header class="${"svelte-1bzzx5e"}"><nav class="${"svelte-1bzzx5e"}"><ul class="${"svelte-1bzzx5e"}"><li class="${"svelte-1bzzx5e"}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1bzzx5e"}"><button class="${["button button-primary svelte-1bzzx5e", $page.path === "/" ? "active" : ""].join(" ").trim()}">Huidige huistaken</button></a></li>
			${isAdmin ? `<li class="${"svelte-1bzzx5e"}"><a sveltekit:prefetch href="${"/change-names"}" class="${"svelte-1bzzx5e"}"><button class="${[
    "button button-primary svelte-1bzzx5e",
    $page.path === "/change-names" ? "active" : ""
  ].join(" ").trim()}">Namen veranderen</button></a></li>
			<li class="${"svelte-1bzzx5e"}"><a sveltekit:prefetch href="${"/change-chores"}" class="${"svelte-1bzzx5e"}"><button class="${[
    "button button-primary svelte-1bzzx5e",
    $page.path === "/change-chores" ? "active" : ""
  ].join(" ").trim()}">Taken veranderen</button></a></li>` : ``}

			<li class="${"svelte-1bzzx5e"}"><a sveltekit:prefetch href="${"/check-chore-completion"}" class="${"svelte-1bzzx5e"}"><button class="${[
    "button button-primary svelte-1bzzx5e",
    $page.path === "/check-chore-completion" ? "active" : ""
  ].join(" ").trim()}">Nieuwe huistaken</button></a></li>
			${isAdmin ? `<li class="${"svelte-1bzzx5e"}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1bzzx5e"}"><button class="${"button button-primary"}">Randomize huistaken</button></a></li>
			<li class="${"svelte-1bzzx5e"}"><a sveltekit:prefetch href="${"/add-history"}" class="${"svelte-1bzzx5e"}"><button class="${[
    "button button-primary svelte-1bzzx5e",
    $page.path === "/add-history" ? "active" : ""
  ].join(" ").trim()}">Geschiedenis toevoegen</button></a></li>
			<li class="${"svelte-1bzzx5e"}"><a sveltekit:prefetch href="${"/change-current-chores"}" class="${"svelte-1bzzx5e"}"><button class="${[
    "button button-primary svelte-1bzzx5e",
    $page.path === "/change-current-chores" ? "active" : ""
  ].join(" ").trim()}">Huidige huistaken veranderen</button></a></li>` : ``}</ul></nav>
</header>`;
});
var css = {
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $chores, $$unsubscribe_chores;
  let $currentMatching, $$unsubscribe_currentMatching;
  let $names, $$unsubscribe_names;
  $$unsubscribe_chores = subscribe(chores, (value) => $chores = value);
  $$unsubscribe_currentMatching = subscribe(currentMatching, (value) => $currentMatching = value);
  $$unsubscribe_names = subscribe(names, (value) => $names = value);
  $$unsubscribe_chores();
  $$unsubscribe_currentMatching();
  $$unsubscribe_names();
  return `
<table class="${"u-full-width"}"><thead><tr><th>Naam</th>
			<th>Huistaak</th></tr></thead>
	<tbody>${each($currentMatching, ({ personId, choreId, completed }, i) => `<tr><td>${escape2($names.find((x) => x.id === personId).name)}</td>
				<td>${escape2($chores.find((x) => x.id === choreId).chore)}</td>
			</tr>`)}</tbody></table>

<button>${validate_component(Fa, "Fa").$$render($$result, {
    size: "1x",
    icon: import_free_solid_svg_icons.faCopy,
    primaryColor: "green"
  }, {}, {})}</button>`;
});
...
var YesNo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { completed } = $$props;
  if ($$props.completed === void 0 && $$bindings.completed && completed !== void 0)
    $$bindings.completed(completed);
  return `<div style="${"display: inline;"}">${validate_component(Fa, "Fa").$$render($$result, {
    size: "2x",
    icon: import_free_solid_svg_icons.faCheck,
    primaryColor: "green",
    style: "padding: 0.1em; opacity: " + (completed ? 1 : 0.3)
  }, {}, {})}</div>

<div style="${"display: inline;"}">${validate_component(Fa, "Fa").$$render($$result, {
    size: "2x",
...
var Check_chore_completion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $currentMatching, $$unsubscribe_currentMatching;
  let $names, $$unsubscribe_names;
  let $chores, $$unsubscribe_chores;
  $$unsubscribe_currentMatching = subscribe(currentMatching, (value) => $currentMatching = value);
  ...
  do {
    $$settled = true;
    $$rendered = `<table class="${"u-full-width"}"><thead><tr><th>Naam</th>
			<th>Taak</th>
			<th>Gedaan?</th></tr></thead>
	<tbody>${each($currentMatching, ({ personId, choreId, completed }, i) => `<tr><td>${escape2($names.find((x) => x.id === personId).name)}</td>
				<td>${escape2($chores.find((x) => x.id === choreId).chore)}</td>
				<td>${validate_component(YesNo, "YesNo").$$render($$result, { completed }, {
      completed: ($$value) => {
        completed = $$value;
        $$settled = false;
      }
...
<button class="${"button button-primary active"}">Volgende </button>`;
  } while (!$$settled);
  $$unsubscribe_currentMatching();
  $$unsubscribe_names();
  $$unsubscribe_chores();
...
var checkChoreCompletion = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Check_chore_completion
});
var Change_current_chores = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $names, $$unsubscribe_names;
  let $$unsubscribe_currentMatching;
  let $chores, $$unsubscribe_chores;
  $$unsubscribe_names = subscribe(names, (value) => $names = value);
  $$unsubscribe_currentMatching = subscribe(currentMatching, (value) => value);
  $$unsubscribe_chores = subscribe(chores, (value) => $chores = value);
  $$unsubscribe_names();
  $$unsubscribe_currentMatching();
  $$unsubscribe_chores();
  return `<form><div class="${"row"}"><div class="${"three columns"}"><b>Namen</b></div>
		<div class="${"three columns"}"><b>Taken</b></div></div>

	${each($names, ({ name }, i) => `<div class="${"row"}"><div class="${"three columns"}"><p>${escape2(name)}</p></div>

			<div class="${"three columns"}"><select name="${""}" id="${""}">${each($chores, ({ id, chore }, i2) => `<option${add_attribute("value", id, 0)}>${escape2(chore)}</option>`)}</select></div>
		</div>`)}</form>`;
});
var changeCurrentChores = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Change_current_chores
});
var ManWoman = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { gender } = $$props;
  if ($$props.gender === void 0 && $$bindings.gender && gender !== void 0)
    $$bindings.gender(gender);
  return `<div style="${"display: inline;"}">${validate_component(Fa, "Fa").$$render($$result, {
    size: "3x",
    icon: import_free_solid_svg_icons.faMale,
    primaryColor: "blue",
    style: "padding: 0.1em; opacity: " + (gender === Gender.Male ? 1 : 0.1)
  }, {}, {})}</div>

<div style="${"display: inline;"}">${validate_component(Fa, "Fa").$$render($$result, {
    size: "3x",
    icon: import_free_solid_svg_icons.faFemale,
    primaryColor: "hotpink",
    style: "padding: 0.1em; opacity: " + (gender === Gender.Female ? 1 : 0.1)
  }, {}, {})}</div>`;
});
var Change_chores = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $chores, $$unsubscribe_chores;
  $$unsubscribe_chores = subscribe(chores, (value) => $chores = value);
  let $$settled;
  let $$rendered;
  do {
    $$settled = true;
    $$rendered = `<form><div class="${"row"}"><div class="${"six columns"}"><b>Taken</b></div>
		<div class="${"two columns"}" style="${"padding: 1em"}"><b>Geslacht</b></div>
		<div class="${"two columns"}" style="${"padding: 1em"}"><b>Hoe veel personen?</b></div></div>
	${each($chores, ({ chore, gender }, i) => `<div class="${"row"}"><div class="${"six columns"}"><label for="${"name" + escape2(i)}">Naam ${escape2(i + 1)}</label>
				<input class="${"u-full-width"}" type="${"text"}" placeholder="${"Naam invullen"}" id="${"name" + escape2(i)}"${add_attribute("value", chore, 0)}></div>
			<div class="${"two columns"}" style="${"padding: 1em"}">${validate_component(ManWoman, "ManWoman").$$render($$result, { gender }, {
      gender: ($$value) => {
        gender = $$value;
        $$settled = false;
      }
    }, {})}</div>
			<div class="${"two columns"}" style="${"padding: 1em"}"><input type="${"number"}" id="${"amount"}" name="${"amount"}" min="${"1"}" value="${"1"}"></div>
		</div>`)}</form>`;
  } while (!$$settled);
  $$unsubscribe_chores();
  return $$rendered;
});
var changeChores = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Change_chores
});
var Check_absence = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $absence, $$unsubscribe_absence;
  let $$unsubscribe_nrPresent;
  let $names, $$unsubscribe_names;
  $$unsubscribe_absence = subscribe(absence, (value) => $absence = value);
  $$unsubscribe_nrPresent = subscribe(nrPresent, (value) => value);
  $$unsubscribe_names = subscribe(names, (value) => $names = value);
  let $$settled;
  let $$rendered;
  do {
    $$settled = true;
    $$rendered = `<table class="${"u-full-width"}"><thead><tr><th>Naam</th>
			<th>Thuis?</th></tr></thead>
	<tbody>${each($absence, ({ personId, present }, i) => `<tr><td>${escape2($names.find((x) => x.id === personId).name)}</td>
				<td>${validate_component(YesNo, "YesNo").$$render($$result, { completed: present }, {
      completed: ($$value) => {
        present = $$value;
        $$settled = false;
      }
...
<button class="${"button button-primary active"}">Volgende </button>`;
  ...
  $$unsubscribe_absence();
  $$unsubscribe_nrPresent();
  $$unsubscribe_names();
  return $$rendered;
});
var checkAbsence = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Check_absence
});
var Choose_chores = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `
<table class="${"u-full-width"}"><thead><tr><th>Naam</th>
			<th>Thuis?</th></tr></thead>
	<tbody></tbody></table>
...
var chooseChores = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Choose_chores
});
var Change_names = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $names, $$unsubscribe_names;
  $$unsubscribe_names = subscribe(names, (value) => $names = value);
  let $$settled;
  let $$rendered;
  do {
    $$settled = true;
    $$rendered = `<form><div class="${"row"}"><div class="${"six columns"}"><b>Namen</b></div>
		<div class="${"two columns"}" style="${"padding: 1em"}"><b>Geslacht</b></div></div>
	${each($names, ({ name, gender }, i) => `<div class="${"row"}"><div class="${"six columns"}"><label for="${"name" + escape2(i)}">Naam ${escape2(i + 1)}</label>
				<input class="${"u-full-width"}" type="${"text"}" placeholder="${"Naam invullen"}" id="${"name" + escape2(i)}"${add_attribute("value", name, 0)}></div>
			<div class="${"two columns"}" style="${"padding: 1em"}">${validate_component(ManWoman, "ManWoman").$$render($$result, { gender }, {
      gender: ($$value) => {
        gender = $$value;
        $$settled = false;
...
var changeNames = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Change_names
});
var Add_history = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $names, $$unsubscribe_names;
  let $$unsubscribe_archiveWeeks;
  let $chores, $$unsubscribe_chores;
  $$unsubscribe_names = subscribe(names, (value) => $names = value);
  $$unsubscribe_archiveWeeks = subscribe(archiveWeeks, (value) => value);
  $$unsubscribe_chores = subscribe(chores, (value) => $chores = value);
  ...
  do {
    $$settled = true;
    $$rendered = `<form><div class="${"row"}"><div class="${"three columns"}"><b>Namen</b></div>
		<div class="${"three columns"}"><b>Taken</b></div>
		<div class="${"two columns"}"><b>Gedaan?</b></div></div>

	${each($names, ({ name }, i) => `<div class="${"row"}"><div class="${"three columns"}"><p>${escape2(name)}</p></div>

			<div class="${"three columns"}"><select name="${"cars"}" id="${"cars"}">${each($chores, ({ id, chore }, i2) => `<option${add_attribute("value", id, 0)}>${escape2(chore)}</option>`)}</select></div>

			<div class="${"two columns"}">${validate_component(YesNo, "YesNo").$$render($$result, { completed: selectedDone[i] }, {
      completed: ($$value) => {
        selectedDone[i] = $$value;
        $$settled = false;
      }
    }, {})}</div>
		</div>`)}</form>

<button class="${"button button-primary active"}">Voeg oud toe </button>

<button class="${"button button-primary active"}">Voeg recent toe </button>`;
  } while (!$$settled);
  $$unsubscribe_names();
  $$unsubscribe_archiveWeeks();
  $$unsubscribe_chores();
  return $$rendered;
});
var addHistory = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Add_history
});
var Admin = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Routes, "Index").$$render($$result, {}, {}, {})}`;
});
